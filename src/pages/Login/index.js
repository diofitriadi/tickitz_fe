    ...
    return(
        ...
        <div className="left-login">
            ...
            <div className="brand-logo">
                <img src={brandLogo} alt=""/><span>wait, watch, wow!</span>
            </div>
        </div>
    <div className="right-login">
        <div className="sign-in">
            ...
            <div className="input-container">
                ...
                <input type="text" name="email" id="email" placeholder="Write your email" required onChange={(e)=> {
            ...
            <div className="input-container">
                ...
                <input type="password" name="password" id="password" placeholder="Write your password" required onChange={(e)=> {
                    setFormAddData((prevData)=>({
                        ...prevData,
                ...
                <input type="submit" name="signin" value="Sign In" onSubmit={(e)=> handleLogin(e)}/>
                <p className="text-center"> Forgot your password ? <a href="reset_password.html">Reset Now</a></p>
                <br/>
                <p className="text-center"> Don't have an account ? <a href="/registration">Sign Up</a></p>
            </form>
        </div>
    </div>
</div>
